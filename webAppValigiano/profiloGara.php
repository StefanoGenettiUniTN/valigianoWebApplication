...
?>
    ...
    <div class="w3-card w3-margin w3-round">
        <?php
            ...
            if($outTitolo = $risQueryTitolo->fetch_assoc())
                echo "<h2 class='w3-margin w3-container' style='height: 8%;'><b>EVENTO:</b> ".$outTitolo["luogo"]."  ".$outTitolo["data"]."</h2>";
            else
    ...
    <div id="outputJQRaggruppamento">
        ...
        <a href="" class="w3-ripple w3-teal w3-button w3-block w3-centered" style="margin:auto; margin-top: 3%; width: 90%;" >AGGIUNGI ISCRITTO</a><br>
            ...
            <div class="w3-responsive"><!--Scroll bar se schermata troppo piccola-->
                ...
                <tr class='cat".$outIscritti["id_categoria"]." record'>
                    ...
                    ";
                        ...
                        echo "
                    <td><button onclick='rimuoviIscritto(\"".$outIscritti["utente_nome"]."\",".$outIscritti["id_utente"].");' class=\"w3-btn w3-ripple\"><img src='baseline_delete_black_18dp.png'></button></td>
                    ";
