...
if(isset($_GET["famID"])) {
    ...
    <body>
    <a href="modificaFamiglia.php" style="text-decoration: none;"><button class="w3-button w3-margin w3-teal w3-display-topright" style="height: 10%;"><i style="margin-right: 30px;"><img src="round_keyboard_backspace_black_18dp.png"></i>Torna alla lista famiglie</button></a>
    <div class="w3-card w3-margin w3-round">
        ...
        if($outTitolo = $risQueryTitolo->fetch_assoc())
            echo "<h2 class='w3-margin w3-container' style='height: 10%;'><b>FAMIGLIA: </b> ".$outTitolo["nome"]." - <u>Membri</u></h2>";
        else
